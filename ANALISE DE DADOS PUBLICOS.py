...
#dados sjc aprovados
valorapro_sjc['01']=(arquivo_sjc['Unnamed: 3'] [5])/pop_sjc
valorapro_sjc['02']=(arquivo_sjc['Unnamed: 3'] [8])/pop_sjc
valorapro_sjc['03']=(arquivo_sjc['Unnamed: 3'] [23])/pop_sjc
valorapro_sjc['04']=(arquivo_sjc['Unnamed: 3'] [34])/pop_sjc
valorapro_sjc['05']=(arquivo_sjc['Unnamed: 3'] [53])/pop_sjc
valorapro_sjc['06']=(arquivo_sjc['Unnamed: 3'] [60])/pop_sjc
valorapro_sjc['07']=(arquivo_sjc['Unnamed: 3'] [65])/pop_sjc
valorapro_sjc['08']=(arquivo_sjc['Unnamed: 3'] [68])/pop_sjc
valorapro_sjc['total']=(arquivo_sjc['Unnamed: 3'] [72])/pop_sjc
#dados sjc apresentados
valorapres_sjc['01']=(arquivo_sjc['Unnamed: 7'] [5])/pop_sjc
valorapres_sjc['02']=(arquivo_sjc['Unnamed: 7'] [8])/pop_sjc
valorapres_sjc['03']=(arquivo_sjc['Unnamed: 7'] [23])/pop_sjc
valorapres_sjc['04']=(arquivo_sjc['Unnamed: 7'] [34])/pop_sjc
valorapres_sjc['05']=(arquivo_sjc['Unnamed: 7'] [53])/pop_sjc
valorapres_sjc['06']=(arquivo_sjc['Unnamed: 7'] [60])/pop_sjc
valorapres_sjc['07']=(arquivo_sjc['Unnamed: 7'] [65])/pop_sjc
valorapres_sjc['08']=(arquivo_sjc['Unnamed: 7'] [68])/pop_sjc
valorapres_sjc['total']=(arquivo_sjc['Unnamed: 7'] [72])/pop_sjc

#dados caçapava aprovados
valorapro_cac['01']=(arquivo_cac['Unnamed: 3'] [5])/pop_cac
valorapro_cac['02']=(arquivo_cac['Unnamed: 3'] [8])/pop_cac
valorapro_cac['03']=(arquivo_cac['Unnamed: 3'] [23])/pop_cac
valorapro_cac['04']=(arquivo_cac['Unnamed: 3'] [34])/pop_cac
valorapro_cac['05']=(arquivo_cac['Unnamed: 3'] [53])/pop_cac
valorapro_cac['06']=(arquivo_cac['Unnamed: 3'] [60])/pop_cac
valorapro_cac['07']=(arquivo_cac['Unnamed: 3'] [65])/pop_cac
valorapro_cac['08']=(arquivo_cac['Unnamed: 3'] [68])/pop_cac
valorapro_cac['total']=(arquivo_cac['Unnamed: 3'] [72])/pop_cac
#dados caçapava apresentados
valorapres_cac['01']=(arquivo_cac['Unnamed: 7'] [5])/pop_cac
valorapres_cac['02']=(arquivo_cac['Unnamed: 7'] [8])/pop_cac
valorapres_cac['03']=(arquivo_cac['Unnamed: 7'] [23])/pop_cac
valorapres_cac['04']=(arquivo_cac['Unnamed: 7'] [34])/pop_cac
valorapres_cac['05']=(arquivo_cac['Unnamed: 7'] [53])/pop_cac
valorapres_cac['06']=(arquivo_cac['Unnamed: 7'] [60])/pop_cac
valorapres_cac['07']=(arquivo_cac['Unnamed: 7'] [65])/pop_cac
valorapres_cac['08']=(arquivo_cac['Unnamed: 7'] [68])/pop_cac
valorapres_cac['total']=(arquivo_cac['Unnamed: 7'] [72])/pop_cac
#dados taubaté aprovados
valorapro_tau['01']=(arquivo_tau['Unnamed: 3'] [5])/pop_tau
valorapro_tau['02']=(arquivo_tau['Unnamed: 3'] [8])/pop_tau
valorapro_tau['03']=(arquivo_tau['Unnamed: 3'] [23])/pop_tau
valorapro_tau['04']=(arquivo_tau['Unnamed: 3'] [34])/pop_tau
valorapro_tau['05']=(arquivo_tau['Unnamed: 3'] [53])/pop_tau
valorapro_tau['06']=(arquivo_tau['Unnamed: 3'] [60])/pop_tau
valorapro_tau['07']=(arquivo_tau['Unnamed: 3'] [65])/pop_tau
valorapro_tau['08']=(arquivo_tau['Unnamed: 3'] [68])/pop_tau
valorapro_tau['total']=(arquivo_tau['Unnamed: 3'] [72])/pop_tau

#dados taubaté apresentados
valorapres_tau['01']=(arquivo_tau['Unnamed: 7'] [5])/pop_tau
valorapres_tau['02']=(arquivo_tau['Unnamed: 7'] [8])/pop_tau
valorapres_tau['03']=(arquivo_tau['Unnamed: 7'] [23])/pop_tau
valorapres_tau['04']=(arquivo_tau['Unnamed: 7'] [34])/pop_tau
valorapres_tau['05']=(arquivo_tau['Unnamed: 7'] [53])/pop_tau
valorapres_tau['06']=(arquivo_tau['Unnamed: 7'] [60])/pop_tau
valorapres_tau['07']=(arquivo_tau['Unnamed: 7'] [65])/pop_tau
valorapres_tau['08']=(arquivo_tau['Unnamed: 7'] [68])/pop_tau
valorapres_tau['total']=(arquivo_tau['Unnamed: 7'] [72])/pop_tau
...
ax.set_ylabel('Valor Apresentado por cidadão')
ax2.set_ylabel('Valor Aprovado por cidadão')
...
ax.set_ylabel('Valor Aprovado por cidadão')
